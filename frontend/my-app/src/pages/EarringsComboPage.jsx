...
const EarringsComboPage = () => {
  ...
  const promotionalAds = [
    "https://example.com/earrings-ad1.jpg",
    "https://example.com/earrings-ad2.jpg",
    "https://example.com/earrings-ad3.jpg",
  ];

  const fetchProducts = async () => {
    try {
      const response = await axios.get('https://jewelry-backend-gq4y.onrender.com/api/earringscombos', {
        params: {
          sort: sortOption,
          page: currentPage,
          limit: itemsPerPage,
      ...
      setProducts(response.data.earringsCombos);
    } catch (error) {
      console.error('Error fetching earrings combos:', error);
    }
  };
...
export default EarringsComboPage;
