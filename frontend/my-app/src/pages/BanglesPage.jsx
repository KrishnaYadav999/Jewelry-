...
const BanglesPage = () => {
  ...
  const promotionalAds = [
    "https://zerakijewels.com/cdn/shop/files/zeraki_banner_30_april_2.jpg?v=1746421911&width=1800",
    "https://zerakijewels.com/cdn/shop/files/zeraki-bangle-offer-banner-2-jan.png?v=1735889135&width=1800",
  ...
  const fetchProducts = async () => {
    try {
      ...
      setProducts(response.data.bangles);
    } catch (error) {
