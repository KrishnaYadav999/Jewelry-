...
const MangalsutraPage = () => {
  ...
  const promotionalAds = [
    'https://zerakijewels.com/cdn/shop/files/zeraki-banner-6-dec.jpg?v=1733731794&width=1800',
    'https://zerakijewels.com/cdn/shop/files/Buy_1_Get_1_FREE_1400_x_500_px_1.png?v=1722941444&width=1400',
  ];
